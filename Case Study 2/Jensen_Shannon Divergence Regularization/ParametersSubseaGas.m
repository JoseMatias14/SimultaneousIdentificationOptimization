...
% par.Q1 = diag([0,0,0,0,0,1e0,0,0]);
% par.Q2 = diag([0,0,0,0,0,5*1e0,0,0]);
par.Q1 = diag([0,0,1e0,0,1e0,1e1,0,0]);
par.Q2 = diag([0,0,1e0,0,1e0,1e1,0,0]);
par.Q3 = diag([0,0,1e0,0,1e0,1e1,0,0]);
% par.Q1 = diag([1e0,1e0,1e0,1e0,1e0,1e1,1e0,1e0]);
% par.Q2 = diag([1e0,1e0,1e0,1e0,1e0,1e1,1e0,1e0]);
