function [gradPlantHat,uk_h,yk_h] = CDAGradient(yk,xk,uk,fk,parPlant,h,H,count)
...
%    uk_h1 = required input incitation (two inputs in the system)
%    yk_h1 = measurements related to the inputs
...
yk_h = [yk_h1,yk_h_1,yk_h2,yk_h_2];
uk_h = [uk_h1,uk_h_1,uk_h2,uk_h_2];
