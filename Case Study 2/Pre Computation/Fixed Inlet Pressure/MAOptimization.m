function [pik,ukArray,rho_k,pi_k_index,epsk,lambdak] = MAOptimization(xk_1,uk_1,fk_1,par,yValuePlant,gradYPlantHat,epsk_1,lambdak_1,rho_k,H,ma)
...
if rho_k(1) < 0.001
    rho_k(1) = rho_k(1) + 0.001;
    rho_k(2) = rho_k(2) - 0.0005;
    rho_k(3) = rho_k(3) - 0.0005;
elseif probNArray(2) < 0.001
    rho_k(1) = rho_k(1) - 0.0005;
    rho_k(2) = rho_k(2) + 0.001;
    rho_k(3) = rho_k(3) - 0.0005;
elseif probNArray(3) < 0.001
    rho_k(1) = rho_k(1) - 0.0005;
    rho_k(2) = rho_k(2) - 0.0005;
    rho_k(3) = rho_k(3) + 0.001;
end
