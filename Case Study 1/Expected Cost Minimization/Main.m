...
%
% Approach used: Expected Cost Minimization 
...
while count <= nIter
    ...
    [pi_k,ukArray,prob_k,pi_k_index,epsk,lambdak] = ECM(dxk,uk,par,yValuePlant,gradPlantHat,epsk,lambdak,prob_k,H,ma);    
    
        % optimal decision associated with each of the ma.nModels models
    ...
    % choosing the optimal input Equation (12)
    uStar = pi_k;
...
save(results,'uOptArray','epsArray','lambdaArray','gradPlantHatArray','gradMeasPlantArray','yPlantArray','yNoNoiseArray','inputPlantArray','uModelArray','probModelArray','modelArrayU','modelArrayProb','nIter','par','ma','parPlant','nIter');
