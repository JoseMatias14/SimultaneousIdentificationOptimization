...
if pr(1)
    print(f1,'-r80','-dpdf','ResultsModels_STD.pdf');
elseif pr(2)
    print(f1,'-r1200','-dtiff','ResultsModels_STD.tif');
end
...
if pr(1)
    print(f3,'-r80','-dpdf','ResultsOptTracking_STD.pdf');
elseif pr(2)
    print(f3,'-r1200','-dtiff','ResultsOptTracking_STD.tif');
end